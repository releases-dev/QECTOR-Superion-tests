# Qector IonQ Decoder v1.7.8 - Frozen Restricted Package

**Title:** Qector IonQ Superion 256 / Walking Cat Decoder v1.7.8-production (frozen wheels + source + certification)
...
- `wheels/`: qector_ionq-1.7.8-cp313-manylinux_2_34_x86_64.whl (Linux, 404860 B, maturin 1.15, CycloneDX SBOM) + qector_ionq-1.7.8-cp311-win_amd64.whl + 1.7.6/1.7.5 cp312 win (compat)
...
- `qector_ionq_v1.7.8_certification (1).zip`, `performance_summary*.csv`, `build_wheel.sh`, `reinstall_and_test.bat`, `README.md`, `LICENSE-PROPRIETARY`, `LICENSE_KEYS.md` (8 NDA keys, 7-day EVAL01-07 + dev)
...
## License / Citation
Proprietary, evaluation under NDA. Wheels only to third parties. Cite: Lessard G., Qector IonQ v1.7.8-production, IonQ Superion 256 / Walking Cat, 2026-09-09. Contact via qector-decoder-v3 maintainer.
